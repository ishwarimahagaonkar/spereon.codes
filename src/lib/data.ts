...
export const products: Product[] = [
  {
    ...
    screenshots: [
      ...
      "/products/stafftrack-hrms/7.png",
      "/products/stafftrack-hrms/8.png",
      "/products/stafftrack-hrms/9.png",
      "/products/stafftrack-hrms/10.png",
      "/products/stafftrack-hrms/11.png",
      "/products/stafftrack-hrms/12.png",
      "/products/stafftrack-hrms/13.png",
      "/products/stafftrack-hrms/14.png",
      "/products/stafftrack-hrms/15.png",
      "/products/stafftrack-hrms/16.png",
      "/products/stafftrack-hrms/17.png",
      "/products/stafftrack-hrms/18.png",
      "/products/stafftrack-hrms/19.png",
      "/products/stafftrack-hrms/20.png",
    ],
    features: [
      "Geolocation attendance & selfie check-in",
      "Leave management with approval flows",
      "Automated payroll & salary slips Summary",
  ...
  },
  {
    ...
    screenshots: [
      "/products/parlour-management-system/1.png",
      "/products/parlour-management-system/2.png",
      "/products/parlour-management-system/3.png",
    ],
    features: [
      "Smart Client Alerts",
